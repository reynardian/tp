...
public class LogicManagerTest {
    ...
    public void execute_validCommand_success() throws Exception {
        ...
        assertCommandSuccess(listCommand, ListCommand.MESSAGE_SUCCESS + SortParameter.NONE, model);
    }
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + AGE_DESC_AMY
                + ADDRESS_DESC_AMY + PARENT_NAME_DESC_AMY + PARENT_PHONE_DESC_AMY + PARENT_EMAIL_DESC_AMY;
